...
//   (matrix += delta) = delta;
//   EqualMatrix(matrix,
//               std::array<std::array<Rational, 2>, 2>{Rational{1, 4}, Rational{1, 1}, Rational{-1, 2}, Rational{-1,
//               1}});

//   EqualMatrix(delta + delta,
//               std::array<std::array<Rational, 2>, 2>{Rational{1, 2}, Rational{2, 1}, Rational{-1, 1}, Rational{-2,
//               1}});
//   EqualMatrix(
...
//   matrix -= delta;
//   EqualMatrix(matrix,
//               std::array<std::array<Rational, 2>, 2>{{Rational{1, 2}, Rational{1, 1}, Rational{3, 1}, Rational{1,
//               1}}});
//   EqualMatrix(matrix -= delta,
//               std::array<std::array<Rational, 2>, 2>{{Rational{1, 4}, Rational{0, 1}, Rational{7, 2}, Rational{2,
//               1}}});
...
//   EqualMatrix(delta - delta,
//               std::array<std::array<Rational, 2>, 2>{Rational{0, 1}, Rational{0, 1}, Rational{0, 1}, Rational{0,
//               1}});
//   EqualMatrix(
//       delta - Matrix<Rational, 2, 2>{Rational{3, 4}, Rational{2, 1}, Rational{5, 2}, Rational{0, 1}},
...
//   EqualMatrix(matrix *= delta,
//               std::array<std::array<Rational, 2>, 3>{Rational{-4, 1}, Rational{19, 8}, Rational{11, 4}, Rational{-5,
//               4},
...
//               std::array<std::array<Rational, 2>, 2>{Rational{-2, 1}, Rational{-1, 4}, Rational{8, 1}, Rational{1,
//               1}});
...
//   matrix *= delta;
//   EqualMatrix(matrix, std::array<std::array<Rational, 2>, 3>{
//                           {Rational{2, 1}, Rational{-1}, Rational{-3, 2}, Rational{1, 2}, Rational{0},
//                           Rational{-4}}});
//   EqualMatrix(matrix *= delta, std::array<std::array<Rational, 2>, 3>{
//                                    {Rational{-4}, Rational{2}, Rational{3}, Rational{-1}, Rational{0},
//                                    Rational{8}}});
...
//   EqualMatrix(matrix /= delta, std::array<std::array<Rational, 2>, 3>{{Rational{-1, 4}, Rational{1, 8}, Rational{3,
//   16},
//                                                                        Rational{-1, 16}, Rational{0}, Rational{1,
//                                                                        2}}});

//   (matrix /= delta) = {Rational{1, 2}, Rational{-1, 2}, Rational{1}};
//   EqualMatrix(matrix, std::array<std::array<Rational, 2>, 3>{Rational{1, 2}, Rational{-1, 2}, Rational{1}});

//   EqualMatrix(matrix / delta, std::array<std::array<Rational, 2>, 3>{Rational{-1, 4}, Rational{1, 4}, Rational{-1,
//   2}}); EqualMatrix(Matrix<int, 2, 2>{90, 2, -8, -4} / 2, std::array<std::array<int, 2>, 2>{45, 1, -4, -2});
...
//                                          Rational{7, 11}, Rational{9, 11}, Rational{-73, 22}, Rational{0},
//                                          Rational{0}, Rational{1, 2}, Rational{2, 11}, Rational{1, 11}, Rational{-13,
//                                          22}});
...
//                                          Rational{640, 3}, Rational{-280}, Rational{9}, Rational{-180},
//                                          Rational{252}});
